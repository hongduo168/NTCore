...
{
    public class MvcRouteConvention : IApplicationModelConvention
    {
        private readonly AttributeRouteModel centralPrefix;

        public MvcRouteConvention(IRouteTemplateProvider routeTemplateProvider)
        {
        ...
        public void Apply(ApplicationModel application)
        {
            ...
            {
                if (!controller.ControllerType.Namespace.EndsWith("Api"))
                {
