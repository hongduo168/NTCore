        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    assign_userid = table.Column<int>(type: "int", nullable: false),
                    create_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    creator_id = table.Column<int>(type: "int", nullable: false),
                    data_state = table.Column<int>(type: "int", nullable: false),
                    expect_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    finish_status = table.Column<int>(type: "int", nullable: false),
                    hotel_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_sort = table.Column<int>(type: "int", nullable: false),
                    data_state = table.Column<int>(type: "int", nullable: false),
                    data_type = table.Column<int>(type: "int", nullable: false),
                    hotel_id = table.Column<int>(type: "int", nullable: false),
                    update_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_customer_request_define", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    create_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    creator_id = table.Column<int>(type: "int", nullable: false),
                    customer_request_define_id = table.Column<int>(type: "int", nullable: false),
                    customer_request_id = table.Column<int>(type: "int", nullable: false),
                    data_state = table.Column<int>(type: "int", nullable: false),
                    hotel_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    room_number = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_state = table.Column<int>(type: "int", nullable: false),
                    hotel_id = table.Column<int>(type: "int", nullable: false),
                    minibar_consume_id = table.Column<int>(type: "int", nullable: false),
                    minibar_product_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_state = table.Column<int>(type: "int", nullable: false),
                    hotel_id = table.Column<int>(type: "int", nullable: false),
                    minibar_id = table.Column<int>(type: "int", nullable: false),
                    package_count = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_state = table.Column<int>(type: "int", nullable: false),
                    hotel_id = table.Column<int>(type: "int", nullable: false),
                    minibar_id = table.Column<int>(type: "int", maxLength: 30, nullable: false),
                    room_number = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
                    update_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updater_id = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    assign_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    coeffcient = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    create_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    creator_id = table.Column<int>(type: "int", nullable: false),
                    data_state = table.Column<int>(type: "int", nullable: false),
                    hotel_id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rowhouse", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "rowhouse_history",
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rowhouse_history", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    auth_type = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    send_status = table.Column<int>(type: "int", nullable: false),
                    update_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updater_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fromtime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    hotel_id = table.Column<int>(type: "int", nullable: false),
                    specific_day = table.Column<int>(type: "int", nullable: false),
                    update_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    updater_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    check_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    check_userid = table.Column<int>(type: "int", nullable: false),
                    coeffcient = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    create_time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    creator_id = table.Column<int>(type: "int", nullable: false),
                    data_state = table.Column<int>(type: "int", nullable: false),
